...
const SALT_ROUNDS = 12; // Secure default for bcryptjs
...
export async function authenticateUser(
    ...
    console.log(`🔍 Verifying password for ${username}: ${isValid ? 'MATCH' : 'MISMATCH'}`);
...
export async function revokeToken(token: string): Promise<boolean> {
    try {
        ...
        // Store in Redis blacklist until natural expiry
